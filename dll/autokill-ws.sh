...
echo -e "\033[1;93m│$NC\033[42m          AUTO KILLER VMESS                 $NC"
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e "STATUS : $sts"
echo -e ""
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "\033[1;93m│  ${grenbo}1.${NC} \033[0;36mEnable AutoKill Vmess${NC}"
echo -e "\033[1;93m│  ${grenbo}2.${NC} \033[0;36mDisable AutoKill Vmess${NC}"
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e " Status $sts"
echo ""
read -rp " Input Number : " -e valkry
if [[ "$valkry" = "1" ]]; then
start
elif [[ "$valkry" = "2" ]]; then
stop
